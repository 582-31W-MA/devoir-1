...
$definitions = [
    "roman" => [
        [
            ...
            "dash" => [
                [
                    ...
                    "diamond" => [
                        [
                            "prefix" => "Faire abstraction de qqc.",
                            "text" => "Ne pas tenir compte de tel(s) élément(s) d’un ensemble, d’une situation, d’un obj., d’une pers., etc.",
                            "examples" => [
                                [
                                    "excerpt" => "Toutes les pêches n’ont pas exactement les mêmes couleurs, la même figure, la même grosseur, le même degré de maturité; elles diffèrent au moins par le lieu, par le temps où vous les voyez. Vous négligez ces différences, vous les écartez, ou, comme on dit, vous en faites abstraction; vous ne considérez ces dernières pêches que par ce qu’elles ont de commun avec la première que vous avez observée; vous prononcez que ce sont encore des pêches : et voilà que l’idée de pêche est devenue générale, et n’est plus composée que des caractères qui conviennent absolument à toutes les pêches. Cette opération s’appelle abstraire.",
                                    "author" => "A.-L.-C. Destutt de Tracy",
                                    "title" => "Éléments d’idéologie, Idéologie proprement dite",
                                    "year" => 1801,
                                    "page" => 89
                                ]
                            ]
        ...
        [
            "text" => "Résultat de l’action d’abstraire",
            "letter" => [
                [
                    "bracketed_prefix" => "Au sing. ou au plur.",
                    "text" => "Idée ou représentation abstraite",
                    "examples" => [
                        [
                            "excerpt" => "... les métaphores ne sont pas moins nécessaires à la métaphysique que les abstractions. Ayez donc recours à l’abstraction, quand la métaphore vous manque, et à la métaphore, quand l’abstraction est en défaut. Saisissez l’évidence, et montrez-la comme vous pourrez : voilà tout l’art et toutes les règles.",
                            "author" => "J. Joubert",
                            "title" => "Pensées, t. 1",
                            "year" => 1824,
                            "page" => 320
